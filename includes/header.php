                    ...
                    <div class="mainmenu">
                        <div id="nav">
                           ...
                           <li role="presentation" class="dropdown">
                                        <a id="drop-one" href="amenities.php" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">
                                          Amenities
                                        </a>
                                        <ul id="menu1" class="dropdown-menu" role="menu">
                                          <li role="presentation"><a role="menuitem" tabindex="-1" href="amenities.php">Existing Amenities</a></li>
                                          <li role="presentation"><a role="menuitem" tabindex="-1" href="upcoming.php">Upcoming Attractions</a></li>
                                        </ul>
                                    </li>     
