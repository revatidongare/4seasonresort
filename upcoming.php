                                        ...
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5 col-sm-6">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="img/facility/UPCOMING-SWIMMING-POOL.png" alt=""></a>
                                                </div>
                                            </div>
                    ...
                    <div class="hotel_facilities_content">
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#pick-up" aria-controls="pick-up" role="tab" data-toggle="tab"><!-- <img src="img/home-facilities-icon-eight.png" alt="pick-up"> --><span>selfi point</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#bar" aria-controls="bar" role="tab" data-toggle="tab"><!-- <img src="img/home-facilities-icon-nine.png" alt="bar"> --><span>swimming pool</span></a>
                                </li>
                                <li role="presentation">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="restaurant">
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5 col-sm-6">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="img/facility/upcoming-nature-view-395x325.png" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="co-lg-7 col-md-7 col-sm-6">
                                                <div class="single-tab-details">
                                    ...
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="img/facility/UPCOMING-POOL-TABLE.png" alt=""></a>
                                                </div>
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="pick-up">
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="img/facility/UPCOMING-SELFIE-POINT.png" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="co-lg-7 col-md-7">
                                                <div class="single-tab-details">
                                ...
                                <div role="tabpanel" class="tab-pane" id="gym">
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="img/facility/UPCOMING-TENTHOUSE.png" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="co-lg-7 col-md-7">
                                                <div class="single-tab-details">
